    ...
    <div class="flex min-h-screen bg-gray-100">
        ...
        <aside class="w-64 bg-anggo-blue text-white hidden md:block shadow-xl fixed h-full z-10 pt-20">
            ...
            <nav class="mt-2">
                ...
                <a href="{{ route('admin.users.index') }}" class="block py-3 px-6 bg-blue-800 border-r-4 border-anggo-gold text-white font-semibold">
        ...
        <div class="flex-1 md:ml-64 p-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-gray-500 mt-1">Kelola data pengguna terdaftar.</p>
                </div>
            </div>
                            ...
                            <tr class="hover:bg-blue-50/50 transition duration-150 even:bg-gray-50">
                                ...
                                <td class="p-4 text-center">
                                    <div class="flex justify-center items-center gap-2">
                                        <a href="{{ route('admin.users.edit', $user->id) }}" class="w-8 h-8 rounded-full bg-yellow-100 text-yellow-600 flex items-center justify-center hover:bg-yellow-500 hover:text-white transition shadow-sm" title="Edit">
                                        ...
                                        @else
                                        <div class="w-8 h-8"></div> <!-- Spacer rapi jika user login -->
                                        @endif
                                    </div>
                                </td>
                            </tr>
